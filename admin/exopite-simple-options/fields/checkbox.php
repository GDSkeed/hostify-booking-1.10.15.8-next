		...
		public function output() {
			...
			switch ( $style ) {
				...
				default:
					...
					echo '<label><input type="checkbox" name="' . $this->element_name() . '" value="yes"' . $this->element_class() . $this->element_attributes()
						. checked( $this->field['default_option'] ?? $this->element_value(), 'yes', false )
						. '/> ' . $label . '</label>';
					break;
			}
