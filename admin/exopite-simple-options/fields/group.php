...
if ( ! class_exists( 'Exopite_Simple_Options_Framework_Field_group' ) ) {
	class Exopite_Simple_Options_Framework_Field_group extends Exopite_Simple_Options_Framework_Fields {
		...
		public function __construct( $field, $value = '', $unique = '', $config = array() ) {
			...
			$defaults = array(
				'group_title'  	=> esc_attr( 'Group Title', 'hostifybooking' ),
				'repeater'     	=> false,
				'cloneable'    	=> true,
				'sortable'   	=> true,
				'accordion'    	=> true,
				'closed'       	=> true,
				'limit'        	=> 0,
				'button_title' 	=> esc_attr( 'Add new', 'hostifybooking' ),
			);
		...
		public function output() {
			...
			if ( $this->field['options']['repeater'] ) {
				...
				echo '<div class="exopite-sof-cloneable-data" data-unique-id="' . $unique_id . '" data-limit="' . $this->field['options']['limit'] . '">' . esc_attr__( 'Max items:', 'hostifybooking' ) . ' ' . $this->field['options']['limit'] . '</div>';
