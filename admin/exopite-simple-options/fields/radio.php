					...
					foreach ( $options as $key => $value ) {
						...
						switch ( $style ) {
							case 'fancy':
								...
								echo '<input type="radio" class="radio-button__input" name="' . $this->element_name() . '" value="' . $key . '"' . $this->element_attributes( $key ) . $this->checked( $this->field['default_option'] ?? $this->element_value(), $key ) . '>';
							...
							default:
								echo '<li><label><input type="radio" name="' . $this->element_name() . '" value="' . $key . '"' . $this->element_attributes( $key ) . $this->checked( $this->field['default_option'] ?? $this->element_value(), $key ) . '/> ' . $value . '</label></li>';
								break;
						}
