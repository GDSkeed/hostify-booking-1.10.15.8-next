...
<div class="row">
	<div class="col">
		<div class="field">
			...
			<input id="hfy-payment-phone" class="input <?= $fill_phone ? '' : 'empty' ?>" type="tel" placeholder="<?= esc_attr__('Phone', 'hostifybooking') ?>" required="" value="<?= esc_attr($fill_phone) ?>" pattern=".+" title="<?= esc_attr__('Phone with country code is mandatory. For example: +1234567890', 'hostifybooking') ?>">
		</div>
	</div>
</div>
